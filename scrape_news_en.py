"""
CCEE News Scraper EN - stahuje články z URL v newsUrl-links-en.json,
extrahuje topic, title, annotation, content, obrázky a soubory.
Ukládá do složky NewsEN/{id}/ s article.json a podsložkami Images/ a Files/.
"""
...
URLS_JSON = SCRIPT_DIR / "newsUrl-links-en.json"
NEWS_DIR = SCRIPT_DIR / "NewsEN"
...
def download_file(url: str, dest_path: Path) -> bool:
    ...
    if not url:
        return False
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "CCEE-News-Scraper-EN/1.0"})
